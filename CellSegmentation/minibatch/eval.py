...
unique_labels = np.unique(r2)  # 获取 r2 中所有唯一的标签
num_cells = len(unique_labels) - 1 if 0 in unique_labels else len(unique_labels)  # 减去背景标签 0（如果存在）

print(f"Number of cells in r2: {num_cells}")
