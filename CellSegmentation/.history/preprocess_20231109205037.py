...
x_train = x_train + x_train_outer[:num_samples]
x_pos=x_pos+x_pos_outer[:num_samples]
x_labels=x_labels+x_labels_outer[:num_samples]
y_train=y_train+y_train_outer[:num_samples]
