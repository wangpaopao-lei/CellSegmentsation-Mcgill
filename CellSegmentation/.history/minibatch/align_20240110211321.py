...
# 打印连通区域的数量和一些标记后的数据
print("Number of features (connected components):", num_features)
print("Sample of labeled matrix:\n", task1_labeled[150:160, 150:160])
