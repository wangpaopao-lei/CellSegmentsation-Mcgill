...
# 统计二值化后的True和False数量
num_true = np.sum(task1_binary)
num_false = np.size(task1_binary) - num_true

print(f"Number of True (>= threshold): {num_true}")
print(f"Number of False (< threshold): {num_false}")
