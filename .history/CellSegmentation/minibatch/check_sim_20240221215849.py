...
if __name__=="__main__":
    ...
    print(nucleus_pixel_count[54])
    vector=nucleus_expression[54]
    print(non_zero_count = np.count_nonzero(vector))
    
    with open('dataset/nucleus_expression.pkl', 'wb') as file:
        pickle.dump(nucleus_expression, file)
