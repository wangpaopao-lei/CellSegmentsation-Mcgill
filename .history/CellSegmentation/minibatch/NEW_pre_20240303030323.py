...
def preproccess_gene_data(
    ...
    with open("dataset/expression_matrix.pkl", "wb") as f:
        pickle.dump(expression_matrix, f)
...
if __name__ == "__main__":
    ...
    np.savez_compressed("dataset/x_pos.npz", x_train_pos=x_train_pos)
    np.savez_compressed("dataset/x_labels.npz", x_train_labels=x_train_labels)
