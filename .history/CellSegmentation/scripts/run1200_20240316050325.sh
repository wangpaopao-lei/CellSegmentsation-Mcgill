...
/home/lei/miniconda3/envs/CS/bin/python -u /mnt/md0/lei/projects/CellSegmentsation/CellSegmentation/src/3_align.py

echo "align done!"

/home/lei/miniconda3/envs/CS/bin/python -u /mnt/md0/lei/projects/CellSegmentsation/CellSegmentation/src/newseg.py
